...
const Navbar = ({ onPayPremium, onHomeClick }) => {
      ...
      <div className="top-bar">
        <div className="container flex justify-between items-center">
          <div className="top-left">
            📧 info@thusanangfs.co.za | 📞 0800 014 5745
          </div>
      ...
      <div className="main-nav">
        <div className="container">
          ...
          <nav className="nav-links desktop-only">
            <a href="#home" className="active" onClick={onHomeClick}>Home</a>
          ...
          <div className="cta-group desktop-only">
            ...
            <a href="tel:0800014574" className="btn btn-primary">
        ...
        {mobileMenuOpen && (
          <div className="mobile-menu">
            <nav className="mobile-nav">
              <a href="#home" onClick={(e) => { onHomeClick(e); closeMobileMenu(); }}>Home</a>
            ...
            <div className="mobile-cta">
              ...
              <a href="tel:0800014574" className="btn btn-primary btn-block">
                📞 Call Us
              </a>
            </div>
          </div>
